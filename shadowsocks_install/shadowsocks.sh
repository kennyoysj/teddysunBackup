...
libsodium_url="https://raw.githubusercontent.com/kennyoysj/teddysunBackup/master/libsodium-1.0.16.tar.gz"
...
download_files(){
    ...
    if check_sys packageManager yum; then
        if ! wget --no-check-certificate https://raw.githubusercontent.com/kennyoysj/teddysunBackup/master/shadowsocks_install/shadowsocks -O /etc/init.d/shadowsocks; then
